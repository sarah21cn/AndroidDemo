...
class SecondTransform extends Transform {
    ...
    void transform(TransformInvocation transformInvocation) throws TransformException, InterruptedException, IOException {
        ...
        println("========================结束Second Transform========================")
        println("Second Transform耗时: " + (System.currentTimeMillis() - startTime) + "ms")
        ...
        if (directoryInput.file.isDirectory()) {
            directoryInput.file.eachFileRecurse { File file ->
                ...
                if (name.endsWith(".class") && !name.startsWith("R\$")
                    ...
                    ClassVisitor classVisitor = new SecondClassVisitor(classWriter)
        ...
        if (jarInput.file.getAbsolutePath().endsWith(".jar")) {
            ...
            while (enumeration.hasMoreElements()) {
                ...
                if (entryName.endsWith(".class") && !entryName.startsWith("R\$")
                    ...
                    ClassWriter classWriter = new ClassWriter(classReader, ClassWriter.COMPUTE_MAXS)
                    ClassVisitor cv = new SecondClassVisitor(classWriter)
